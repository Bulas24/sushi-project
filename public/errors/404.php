...
<head>
    ...
    <style type="text/css">
        body{
            background:url(/errors/images/bg.png);
            margin:0;
...
<img src="/errors/images/label.png" class="w3l-logo" alt="Error label"/>
<div class="wrap">
    <div class="logo">
        <img src="/errors/images/woody-404.png" class="w3l-logo1" alt="Error"/>
        <div class="sub">

...
<section class="content-header">
    <h1>
        Заказ № <?=$order['id'];?>
        <?php if (!$order['status']):?>
            <a href="<?=ADMIN;?>/order/change?id=<?=$order['id'];?>&status=1" class="btn btn-default btn-xs">Отправить в работу</a>
        <?php elseif($order['status'] == '1'):?>
            <a href="<?=ADMIN;?>/order/change?id=<?=$order['id'];?>&status=4" class="btn btn-info btn-xs">Подготовлен</a>
        <?php elseif($order['status'] == '4'):?>
            <a href="<?=ADMIN;?>/order/change?id=<?=$order['id'];?>&status=2" class="btn btn-success btn-xs">Выполнить</a>
        <?php elseif($order['status'] == '3'):?>
            <a href="<?=ADMIN;?>/order/change?id=<?=$order['id'];?>&status=1" class="btn btn-default btn-xs">Отправить в работу</a>
        <?php elseif($order['status'] == '2'):?>
            <a href="<?=ADMIN;?>/order/change?id=<?=$order['id'];?>&status=1" class="btn btn-default btn-xs">Вернуть в работу</a>
        <?php endif;?>
        <a href="<?=ADMIN;?>/order/edit?id=<?=$order['id'];?>" class="btn btn-primary btn-xs">Редактировать заказ</a>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="<?=ADMIN;?>/user/edit?id=<?=$user_order['user_id'];?>"><i class="fa fa-fw fa-edit"></i>Редактировать</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

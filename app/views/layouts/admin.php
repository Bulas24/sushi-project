            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?= ADMIN ?>/order">Все заказы</a></li>
                        <li><a href="<?= ADMIN ?>/order/new">Новые заказы</a></li>
                        <li><a href="<?= ADMIN ?>/order/work">Заказы в работе</a></li>
                        <li><a href="<?= ADMIN ?>/order/wait">Подготовленые заказы</a></li>
                        <li><a href="<?= ADMIN ?>/order/ok">Выполненые заказы</a></li>
                        <li><a href="<?= ADMIN ?>/order/online">Оплачены онлайн</a></li>
                    </ul>
                </li>
...
<i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-home"></i> <span>Адреса самовывоза</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
